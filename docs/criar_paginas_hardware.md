# Cursor/Claude Prompt - Criar/Implementar páginas de gerenciamento para   HARDWARE   http://localhost:5173/v1 (@01_source/frontend) http://localhost:5174/v0 (@01_source/frontend_v0)
...
2. Implementar/codar as páginas (novas ou atualizar) para gerenciar as tabelas relacionadas ao domínio     HARDWARE (RELACIONAR COM OUTROS DOMÍNIOS) 
3. Manter padrão UI
...
8. Endpoints: CRUD HARDWARE (RELACIONAR COM OUTROS DOMÍNIOS) (e outros associados com o projeto), webhook config, api key rotation entre outras possibilidades (que sejam necessárias)
