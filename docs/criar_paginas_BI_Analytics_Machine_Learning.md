# Cursor/Claude Prompt - Criar/Implementar páginas de gerenciamento para  BI, Analytics e Machine Learning http://localhost:5173/v1 (@01_source/frontend) http://localhost:5174/v0 (@01_source/frontend_v0)
...
2. Implementar, ou seja, codar as páginas novas ou atualizar anteriores para gerenciar as tabelas relacionadas ao domínio  BI, Analytics e Machine Learning.
3. Criar os endpoints de integrações e atualizar os atuais, se necessários.
4. Criar os Endpoints:  BI, Analytics e Machine Learning (e outros), webhook config, api key rotation entre outras possibilidades (que sejam necessárias)
...
1o. PROMPT: Codar o pedido em @docs/criar_paginas_marketplace_sellers.md. Ter como referência o documento @02_docker/complete_schema_20260526_a.sql
2o. PROMPT: Buscar criar mais páginas ou seções para BI, Analytics e Machine Learning. Se necessário criar tabelas e relações para termos nível profissional/mundial.
3o. PROMPT: Considerar InPost, DHL, Magalu, MercadoLivre, Amazon, DPD, Correios, CTT, WORTEN, EL CORTE INGLES entre outros players do segmento de LOCKERS em nível mundial para rever e para complementar  BI, Analytics e Machine Learning
...
7o. PROMPT: Codar novas possibilidades dentro do domínio  BI, Analytics e Machine Learning que não visualizei e devem ser implementados para melhor eficiência e uso do projeto.
