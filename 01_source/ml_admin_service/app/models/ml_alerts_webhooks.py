...
class MlReadinessScoreHistory(Base):
    __tablename__ = "ml_readiness_score_history"

    id = Column(String(36), primary_key=True)
    network_player_id = Column(String(36), nullable=False, index=True)
    network_player_code = Column(String(48), nullable=False)
...
class MlReadinessAlert(Base):
    __tablename__ = "ml_readiness_alerts"
...
class MlCapabilityWebhook(Base):
    __tablename__ = "ml_capability_webhooks"
...
class MlCapabilityWebhookDelivery(Base):
    __tablename__ = "ml_capability_webhook_deliveries"
