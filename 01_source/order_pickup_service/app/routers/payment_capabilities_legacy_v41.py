...
# 04/04/2026 - read_payment_capabilities
#
# Objetivo:
...
@router.get("/")
def get_payment_capabilities_anterior(
...
def read_payment_capabilities(
    region: str = Query(..., min_length=2, max_length=20, description="Código da região, ex: SP, PT"),
    channel: Literal["online", "kiosk"] = Query(..., description="Canal operacional"),
    context: str = Query(..., min_length=2, max_length=80, description="Contexto operacional, ex: checkout, purchase, pickup"),
