-- Filtro para só mostrar problemas / casos ruins
-- usa a mesma query de _SELECT_visao_unica_tipo_semaforo.sql
...
ORDER BY
    ...
    END,
    o.created_at DESC
) -- ← Removeu o ponto e vírgula daqui

SELECT *
FROM diagnostico
WHERE diagnostico_final <> 'OK_AGUARDANDO_RETIRADA'
  AND diagnostico_final <> 'OK_EXPIRADO_LIBERADO'
  AND diagnostico_final <> 'OK_RETIRADO'
ORDER BY order_id;
