...
const PublicNotFoundPage = lazy(() => import("./pages/public/PublicNotFoundPage")); // ← NOVO IMPORT
    ...
    >
      ...
      {opsEnabled && (
        <div className="nav-ops-group" role="group" aria-label="Ferramentas operacionais">
          ...
          <Link className="nav-link nav-link--dev" to="/ops/analytics/pickup">ops /analytics/pickup</Link>
        </div>
      )}
