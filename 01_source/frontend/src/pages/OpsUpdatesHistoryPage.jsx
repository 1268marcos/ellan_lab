...
const UPDATES = [
  ...
  },
  {
    ...
    title: "Handoff D12 + aceite D13 no ZIP (paridade D11) e Playwright `public-catalog-to-checkout`",
    description:
      "Novo util `fiscalSprint2D12D13Evidence.js` (Vitest): export `SPRINT2_D12_ACCOUNTING_HANDOFF_*.json`, `SPRINT2_D13_ACCOUNTING_ACCEPTANCE_*.json` e anexos assinados no pacote diário; ZIP executivo com `SPRINT2_D12_ACCOUNTING_HANDOFF_EXEC_*` e `SPRINT2_D13_ACCOUNTING_ACCEPTANCE_EXEC_*`. E2E `e2e/public-catalog-to-checkout.spec.ts` cobre `/comprar` → `/checkout` com query mínima (mocks gateway/runtime + auth pickup).",
    uiRoutesNew: ["/ops/updates"],
    apiRoutesNew: [],
    routes: [
      "Frontend: 01_source/frontend/src/utils/fiscalSprint2D12D13Evidence.js",
      "Frontend: 01_source/frontend/src/utils/fiscalSprint2D12D13Evidence.test.js",
    ...
    directLinkLabel: "Abrir handoff contábil diário (D12/D13)",
  },
  {
    dateTime: "2026-05-01T12:00:00-03:00",
    date: "2026-05-01",
    scope: "Sprint 2 Fiscal — D11 evidência por order_id",
    title: "Rollup D11 (SPRINT2_D11_ORDER_ID_ROLLUP) + ZIP diário e executivo",
    description:
      "Util partilhado `fiscalD11OrderIdRollup.js` com testes Vitest; cartão e export JSON em `ops/fiscal/providers`; handoff `localStorage` inclui `order_id_rollup` e `summary.unique_orders_with_gaps`. `fiscal/management-daily` mostra fila por pedido, export dedicado e anexo assinado no pacote diário; `fiscal/accounting-close` inclui `SPRINT2_D11_ORDER_ID_ROLLUP_EXEC_*` no ZIP executivo. Smoke Playwright `e2e/kiosk-touch-models.spec.ts` (mock auth pickup) e `VITE_ENABLE_OPS_ROUTES` no webServer do Playwright.",
    uiRoutesNew: ["/ops/updates"],
    apiRoutesNew: [],
    routes: [
      "Frontend: 01_source/frontend/src/utils/fiscalD11OrderIdRollup.js",
      "Frontend: 01_source/frontend/src/pages/OpsFiscalProvidersPage.jsx",
      "Frontend: 01_source/frontend/src/pages/FiscalManagementDailyPage.jsx",
      "Frontend: 01_source/frontend/src/pages/FiscalAccountingClosePage.jsx",
      "Frontend: 01_source/frontend/e2e/kiosk-touch-models.spec.ts",
      "Frontend: 01_source/frontend/e2e/public-comprar-catalog.spec.ts",
      "Frontend: 01_source/frontend/playwright.config.ts",
      "Docs: docs/PLANO_30_DIAS_GLOBAL_POR_PERSONA.md",
      "UI /ops/updates",
    ],
    directLink: "/ops/fiscal/providers",
    directLinkLabel: "Abrir D11 fiscal (providers)",
  },
  {
    dateTime: "2026-04-30T18:22:00-03:00",
    date: "2026-04-30",
    scope: "Sprint 3 — OPS KIOSK touch (protótipo)",
    title: "KIOSK touch — modelos de tela v1 (/ops/kiosk-touch-models)",
    description:
      "Página OPS com quatro modelos de tela (A–D), checklist de usabilidade n≥8 com persistência local, export JSON e badge de versão no cabeçalho. Definições podem ser sobrescritas via localStorage (`ops_kiosk_touch_models_definitions_v1`); quando ausentes ou inválidas, os modelos canónicos do lab são aplicados. Tema claro com contraste reforçado nos cartões selecionados.",
    uiRoutesNew: ["/ops/kiosk-touch-models", "/ops/updates"],
    apiRoutesNew: [],
    routes: [
      "Frontend: 01_source/frontend/src/pages/OpsKioskTouchModelsPage.tsx",
      "Frontend: 01_source/frontend/src/components/OpsPageTitleHeader.tsx",
      "Frontend: 01_source/frontend/src/App.jsx",
      "Docs: docs/PLANO_30_DIAS_GLOBAL_POR_PERSONA.md",
      "UI /ops/updates",
    ],
    directLink: "/ops/kiosk-touch-models",
    directLinkLabel: "Abrir KIOSK touch (modelos v1)",
  },
  {
