...
const groups: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/ops/rentals/admin?tab=settlements', label: 'Liquidações operadores', newTag: 'New' },
      { to: '/ops/rentals/admin?tab=sla', label: 'Políticas SLA' },
      { to: '/ops/rentals/admin?tab=premium', label: 'Breaches, disputas, renovação', newTag: 'New' },
      { to: '/ops/rentals/admin?tab=events', label: 'Eventos / auditoria' },
      { to: '/ops/rentals/admin?tab=integrations', label: 'Webhooks e API keys' },
      { to: '/ops/rentals/admin?tab=advanced', label: 'Avançado — acesso, caução, pricing', newTag: 'New' },
    ],
  },
  {
    key: 'marketplace',
