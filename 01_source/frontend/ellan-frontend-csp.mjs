 ...
 *
 * Sprint 3 hardening (~85%): `script-src-attr 'none'`, `navigate-to 'self'`.
 * `style-src 'unsafe-inline'` mantido até migração de estilos; `upgrade-insecure-requests` só em gateway HTTPS (ver Nginx exemplo).
 */
