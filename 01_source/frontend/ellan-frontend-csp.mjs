...
export const ELLAN_FRONTEND_CSP =
  "default-src 'self'; base-uri 'self'; form-action 'self'; object-src 'none'; frame-ancestors 'none'; frame-src 'none'; img-src 'self' data: https:; font-src 'self' data: https:; media-src 'self' data: https:; style-src 'self' 'unsafe-inline'; script-src 'self'; script-src-attr 'none'; worker-src 'self' blob:; manifest-src 'self'; connect-src 'self' http://127.0.0.1:8000 http://127.0.0.1:8003 http://127.0.0.1:8010 http://127.0.0.1:8020 http://127.0.0.1:8200 http://127.0.0.1:8201 http://127.0.0.1:8202 http://127.0.0.1:8047 http://localhost:8000 http://localhost:8003 http://localhost:8010 http://localhost:8020 http://localhost:8200 http://localhost:8201 http://localhost:8202 http://localhost:8047 ws://127.0.0.1:5173 ws://127.0.0.1:5174 ws://127.0.0.1:4173 ws://localhost:5173 ws://localhost:5174 ws://localhost:4173 https://api.github.com https://github.com";
