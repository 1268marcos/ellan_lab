...
# =========================================================
# LOCKER ACTIONS (RUNTIME = EXECUTOR PURO)
# =========================================================
...
def locker_allocate(
    ...
    """
    NOVO CONTRATO:
    - runtime não decide SKU
    - runtime não decide TTL
    - runtime não escolhe slot
    - runtime apenas EXECUTA a reserva do slot já decidido no backend central
    """
