...
API_PREFIX = "/api/v1/capability-admin"
...
app = FastAPI(title="capability-admin-service", lifespan=lifespan)
app.add_middleware(
    CORSMiddleware,
...
app.include_router(composition.router, prefix=API_PREFIX)
app.include_router(geo.router, prefix=API_PREFIX)
app.include_router(ecosystem.router, prefix=API_PREFIX)
app.include_router(matrix.router, prefix=API_PREFIX)
